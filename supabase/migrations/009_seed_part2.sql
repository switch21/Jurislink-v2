...
VALUES
  ('a1000000-000d-0000-0000-000000000001', 'FAC-2025-001', 'facture', 500000, 500000, 'paye', NOW() - interval '45 days', NOW() - interval '30 days', 'a1000000-0008-0000-0000-000000000001', 'a1000000-0005-0000-0000-000000000001', 'a1000000-0009-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'forfait', 0, NULL, 'Honoraires provision dossier foncier', NOW(), NOW()),
  ...
  ('a1000000-000d-0000-0000-000000000004', 'FAC-2024-015', 'facture', 200000, 200000, 'paye', NOW() - interval '120 days', NOW() - interval '105 days', 'a1000000-0008-0000-0000-000000000005', 'a1000000-0005-0000-0000-000000000001', 'a1000000-0009-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000001', 'forfait', 0, NULL, NULL, NOW(), NOW()),
  ('a1000000-000d-0000-0000-000000000005', 'FAC-2025-004', 'avoir', 150000, 0, 'annule', NOW() - interval '20 days', NULL, 'a1000000-0008-0000-0000-000000000004', 'a1000000-0005-0000-0000-000000000001', 'a1000000-0009-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000001', NULL, 0, NULL, 'Avoir émis pour erreur de facturation', NOW(), NOW()),
  ...
  ('a1000000-000d-0000-0000-000000000007', 'FAC-2025-006', 'facture', 400000, 400000, 'paye', NOW() - interval '5 days', NOW() + interval '25 days', 'a1000000-0008-0000-0000-000000000001', 'a1000000-0005-0000-0000-000000000001', 'a1000000-0009-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'horaire', 0, NULL, NULL, NOW(), NOW()),
  ('a1000000-000d-0000-0000-000000000008', 'DEV-2025-001', 'devis', 2500000, 0, 'non_paye', NOW() - interval '1 day', NULL, 'a1000000-0008-0000-0000-000000000008', 'a1000000-0005-0000-0000-000000000001', 'a1000000-0009-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000001', 'forfait', 0, NULL, NULL, NOW(), NOW()),
  ('a1000000-000d-0000-0000-000000000009', 'FAC-2024-020', 'facture', 350000, 350000, 'paye', NOW() - interval '40 days', NOW() - interval '25 days', 'a1000000-0008-0000-0000-000000000001', 'a1000000-0005-0000-0000-000000000001', 'a1000000-0009-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', NULL, 0, NULL, NULL, NOW(), NOW()),
  ('a1000000-000d-0000-0000-000000000010', 'REC-2025-001', 'recu', 150000, 150000, 'paye', NOW() - interval '10 days', NULL, 'a1000000-0008-0000-0000-000000000002', 'a1000000-0005-0000-0000-000000000001', 'a1000000-0009-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', NULL, 0, NULL, NULL, NOW(), NOW()),
  ('a1000000-000d-0000-0000-000000000011', 'LBV-FAC-2025-001', 'facture', 600000, 0, 'non_paye', NOW() - interval '15 days', NOW() - interval '3 days', 'a1000000-0008-0000-0000-000000000009', 'a1000000-0005-0000-0000-000000000002', 'a1000000-0009-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000001', NULL, 0, NULL, NULL, NOW(), NOW());
...
-- Section 23: Time Entries (total_amount n'existe pas dans la DB)
INSERT INTO time_entries (id, description, start_time, end_time, duration, is_billable, hourly_rate, tenant_id, user_id, case_id, created_at, updated_at)
VALUES
  ('a1000000-0017-0000-0000-000000000001', 'Étude du dossier foncier Kamga', NOW() - interval '5 days', NOW() - interval '5 days', 7200, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000001', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000002', 'Rédaction conclusions Kamga', NOW() - interval '3 days', NOW() - interval '3 days', 14400, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000001', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000003', 'Consultation client Diallo', NOW() - interval '7 days', NOW() - interval '7 days', 3600, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000002', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000004', 'Recherche jurisprudence sociale', NOW() - interval '6 days', NOW() - interval '6 days', 5400, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000004', 'a1000000-0009-0000-0000-000000000002', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000005', 'Analyse factures Hadj', NOW() - interval '4 days', NOW() - interval '4 days', 5400, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000005', 'a1000000-0009-0000-0000-000000000003', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000006', 'Préparation référé Epee', NOW() - interval '1 day', NOW() - interval '1 day', 10800, true, 50000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000006', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000007', 'Préparation référé Epee', NOW() - interval '1 day', NOW() - interval '1 day', 7200, true, 50000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000004', 'a1000000-0009-0000-0000-000000000006', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000008', 'Entretien client Nkoulou', NOW() - interval '3 days', NOW() - interval '3 days', 3600, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000007', NOW(), NOW()),
  ('a1000000-0017-0000-0000-000000000009', 'Réunion interne - stratégie Epee', NOW() - interval '2 days', NOW() - interval '2 days', 3600, false, 0, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', NULL, NOW(), NOW());
