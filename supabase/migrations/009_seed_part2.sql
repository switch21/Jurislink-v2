...
INSERT INTO time_entries (id, description, start_time, end_time, duration, is_billable, hourly_rate, tenant_id, user_id, case_id, created_at)
VALUES
  ('a1000000-0017-0000-0000-000000000001', 'Étude du dossier foncier Kamga', NOW() - interval '5 days', NOW() - interval '5 days', 7200, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000001', NOW()),
  ('a1000000-0017-0000-0000-000000000002', 'Rédaction conclusions Kamga', NOW() - interval '3 days', NOW() - interval '3 days', 14400, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000001', NOW()),
  ('a1000000-0017-0000-0000-000000000003', 'Consultation client Diallo', NOW() - interval '7 days', NOW() - interval '7 days', 3600, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000002', NOW()),
  ('a1000000-0017-0000-0000-000000000004', 'Recherche jurisprudence sociale', NOW() - interval '6 days', NOW() - interval '6 days', 5400, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000004', 'a1000000-0009-0000-0000-000000000002', NOW()),
  ('a1000000-0017-0000-0000-000000000005', 'Analyse factures Hadj', NOW() - interval '4 days', NOW() - interval '4 days', 5400, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000005', 'a1000000-0009-0000-0000-000000000003', NOW()),
  ('a1000000-0017-0000-0000-000000000006', 'Préparation référé Epee', NOW() - interval '1 day', NOW() - interval '1 day', 10800, true, 50000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000006', NOW()),
  ('a1000000-0017-0000-0000-000000000007', 'Préparation référé Epee', NOW() - interval '1 day', NOW() - interval '1 day', 7200, true, 50000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000004', 'a1000000-0009-0000-0000-000000000006', NOW()),
  ('a1000000-0017-0000-0000-000000000008', 'Entretien client Nkoulou', NOW() - interval '3 days', NOW() - interval '3 days', 3600, true, 25000, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', 'a1000000-0009-0000-0000-000000000007', NOW()),
  ('a1000000-0017-0000-0000-000000000009', 'Réunion interne - stratégie Epee', NOW() - interval '2 days', NOW() - interval '2 days', 3600, false, 0, 'a1000000-0005-0000-0000-000000000001', 'a1000000-0007-0000-0000-000000000003', NULL, NOW());
