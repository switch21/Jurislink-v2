            ...
            {tab === 'cabinet' && <>
              ...
              <CardContent className="pt-4">
                <form onSubmit={handleCabinetSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full h-11 bg-[var(--primary)] hover:bg-[#164070] text-white rounded-lg font-medium" disabled={loading}>{loading ? <RefreshCw className="size-4 animate-spin" /> : 'Se connecter'}</Button>
                </form>
              </CardContent>
            ...
            {tab === 'portal' && <>
              ...
              <CardContent className="pt-4">
                <form onSubmit={handlePortalSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full h-11 bg-[var(--primary)] hover:bg-[#164070] text-white rounded-lg font-medium" disabled={portalLoading}>{portalLoading ? <RefreshCw className="size-4 animate-spin" /> : 'Accéder à mon espace'}</Button>
                </form>
