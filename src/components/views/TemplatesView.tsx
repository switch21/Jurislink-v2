...
import type { Client, CaseItem, DocTemplate } from '@/types'
...
import { Plus, Edit, Trash2, Eye, MoreHorizontal, FileCode2, Sparkles, BookOpen, Hash, Copy } from 'lucide-react'
            ...
            <Table><TableHeader><TableRow>
              ...
              {(templates || []).map((t: DocTemplate) => (
                <TableRow key={t.id}>
                  ...
                  <TableCell className="hidden md:table-cell text-xs text-[#9CA3AF]">{t.updatedAt ? new Date(t.updatedAt).toLocaleDateString('fr-FR') : '—'}</TableCell>
                  <TableCell>
