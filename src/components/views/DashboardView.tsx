...
import {
  STATUS_LABELS, TYPE_LABELS, EVENT_TYPE_LABELS, CRIT_COLORS, CHART_COLORS,
} from '@/lib/constants'
import {
  fmtDate, fmtMoney, fmtDateTime, initials, relativeTime,
} from '@/lib/helpers'
import type { DashboardStats, AuditLogItem, CaseItem } from '@/types'
...
import {
  Plus, Receipt, Calendar, CheckCircle2, ClipboardList, TrendingUp, AlertOctagon, AlertTriangle,
  AlertCircle, FileText, FolderOpen, Gavel, Timer, Activity, Briefcase, Users, UserCircle,
} from 'lucide-react'

// @ts-expect-error — caseList/setSelectedCase are module-level references from the parent component
// These are kept as-is from the original monolithic page.tsx extraction
declare const caseList: CaseItem[]
// @ts-expect-error — module-level reference
declare const setSelectedCase: (c: CaseItem) => void
...
export function DashboardView() {
  ...
  const finData = (stats as any).financial
