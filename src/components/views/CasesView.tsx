...
import {
  STATUS_COLORS, STATUS_LABELS, PRIORITY_COLORS, PRIORITY_LABELS, TYPE_LABELS,
  EVENT_TYPE_LABELS, BILLING_LABELS, ROLE_LABELS,
} from '@/lib/constants'
import {
  fmtDate, fmtMoney, fmtFileSize, fmtDateTime, initials, relativeTime,
  taskStatusColor, taskStatusLabel,
} from '@/lib/helpers'
import type {
  Client, CaseItem, Doc, EventItem, CaseAssignment, CaseNote,
  UserItem, ConflictResult, Invoice, TaskItem,
} from '@/types'
...
import {
  Plus, Search, Edit, Briefcase, Users, Scale, MapPin, Banknote, Lock,
  Calendar, MessageSquare, FileText, ClipboardList, Receipt, Wallet, MessageCircle,
  CalendarPlus, Loader2, X, ArrowUpDown, Activity, UserCircle, Mail, Send,
  Trash2, Download, Eye, FileImage, Tag, AlertTriangle, Check, SearchX,
} from 'lucide-react'
